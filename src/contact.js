...
const contactContent = [
    ...
    {tag: 'form', attr: '', content: '', parent:  'formContainer'},
    {tag: 'label', attr: {for:'full-name'} , content: 'Full Name', parent: 'formContainer'},
    {tag: 'input', attr: {type: 'text', id:'full-name', name:'full-name', required: ''}, content: '', parent: 'formContainer'},
